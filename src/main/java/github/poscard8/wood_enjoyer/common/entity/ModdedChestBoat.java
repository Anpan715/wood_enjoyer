...
public class ModdedChestBoat extends ModdedBoat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public ModdedChestBoat(EntityType<? extends ModdedChestBoat> type, Level level) {
        super(type, level);
    }

    public ModdedChestBoat(Level level, double x, double y, double z) {
        this(ModEntities.MODDED_CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return this.getModdedVariant() == Type.WALNUT ? ModItems.WALNUT_CHEST_BOAT.get() : ModItems.CHESTNUT_CHEST_BOAT.get();
    }

    // copied game code from here
